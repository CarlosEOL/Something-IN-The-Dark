...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			if (Input.GetKey(KeyCode.F) && isInCoolDown == false && hasFlashlight)
			{
				TurnOnFlashlight();
		...
		{
			if (collision.TryGetComponent(out Interactable objectToInteract))
			{
		...
		{
			if (collision.TryGetComponent(out Interactable objectLeavingInteract))
			{
